...
const Meetings = () => {
  ...
  return (
    <div className="h-full bg-white rounded-lg shadow-md p-6 overflow-auto">
      <h1 className="text-3xl font-bold text-blue-500 mb-6">Your Meetings</h1>
      {meetings && meetings.length > 0 ? (
        ...
        <Alert variant="warning" className="mb-6 bg-yellow-100 border-yellow-400">
          <AlertDescription className="text-yellow-700">
            No upcoming meetings found for {authEmail}.
          </AlertDescription>
        </Alert>
      )}
    </div>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="mt-6 space-x-2">
            <Button variant="outline" className="text-red-500 border-red-500 hover:bg-red-50" onClick={() => window.open(meeting.rescheduleorcancel_url, '_blank')}>
